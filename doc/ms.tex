...
\ion{Si}{2} velocity, $v_{\ion{Si}{2}\,\lambda6355}$, to a fixed grid at 1\,d
intervals. We then take the median $v_{\ion{Si}{2}\,\lambda6355}$ for each
point on the grid, and only retain those points with at least 3 SNe (to
...
\begin{figure}[htb]
  ...
  \caption{\textbf{Velocity evolution of \ion{Si}{2},   
           $v_{\ion{Si}{2}\,\lambda6355}$, for \abc\ compared to the median 
           ...
           XXX $\sim$200\,km\,s$^{-1}$ XXX, around $T_{B,\mathrm{max}}$.
