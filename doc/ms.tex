...
% \amiller{Revisit this paragraph in context of discussion -- might need to be moved to later section} As discussed in Section \ref{sec:lc_energy}, the initial light curve
% of \abc\ is probably purely powered by the radioactive decay of
% $^{56}$Ni. Thus, the initial rise of the light curve depends on
% the depth of the shallowest layer where $^{56}$Ni is deposited
% \citep{2014ApJ...784...85P}. According to theoretical models
...
\citep{2012ApJ...752L..26P}. Thus, models of \abc\ must explain the anomously strong \ion{C}{2} absorption observed shortly after explosion.
...
\amiller{Need to thank Rollin for chatting about \ion{C}{2}}
\amiller{Need to thank Uli, Rahman for chatting about SALT2}

% Observers: Michael West, Gemini observers, J. Cohen, Plant,J.Torres,Jang,Cunningham,Guhathakurta, Ravi, Cao, Yan, Vedantham, Kulkarni, N. Suzuki, Y. Cao, V. Ravi, Walters, Lunnan, Ho, De
