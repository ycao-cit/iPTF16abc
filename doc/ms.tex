...
\amiller{need to mention velocities}
...
We conclude that the early observations of \abc\ can be explained if the $^{56}$Ni synthesized in the explosion is mixed into the outermost layers of the SN ejecta. 
