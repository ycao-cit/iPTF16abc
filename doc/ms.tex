...
illustrated in Figure~\ref{fig:lightcurve}.  The photometry is shown in the AB system with a zero point of 
$3631$\,Jy. As previously noted the color terms necessary to convert $g_\mathrm{PTF}$ to the AB system are unknown and assumed to be zero.
...
\software{\texttt{PTFIDE} \citep{Masci2017PASP}, \texttt{SALT2}, \texttt{SNID}, \texttt{UVOTSOURCE}}.
