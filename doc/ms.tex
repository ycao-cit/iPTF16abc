...
the \ion{Ca}{2}\,H$+$K and \ion{Na}{1}\,D doublets. \textbf{Despite large
...
the EW of \ion{Na}{1}\,D and extinction has a large scatter, and
\citet{2013ApJ...779...38P} have shown that \ion{Na}{1}\,D absorption is a
...
features of a SN Ia, such as \ion{Si}{2} and \ion{S}{2}, can be easily
...
\AA, attributed to \ion{Si}{2}\,$\lambda\lambda$5972, 6355, respectively.
...
\ion{Si}{2}$\,\lambda6355$ absorption minimum is compared to the median
...
\begin{figure}[htb]
  ...
  \caption{
  \textbf{Velocity evolution of \ion{Si}{2},
...
\ion{Si}{2} or \ion{Ca}{2} can be used as a proxy
\citep{2014ApJ...784...85P,2016ApJ...826..144S}. In the case of \abc, the
\ion{Ca}{2} IR triplet is very weak, likely due to high temperatures in the
ejecta. Thus, we determine the photospheric velocity from the
\ion{Si}{2}\,$\lambda$6355 line. Visual inspection shows no sign of
multi-velocity components of \ion{Si}{2}, and that the
\ion{C}{2}\,$\lambda$6580 line overlaps the red wing of the \ion{Si}{2} line
...
\ion{Si}{2}, \ion{C}{2} and the continuum, respectively. The expansion
velocity of \ion{Si}{2} is measured by the central wavelength of the
\ion{Si}{2} Gaussian kernel.
...
\begin{figure*}[!thb]
  ...
  \caption{
  Constraints on $t_\mathrm{exp}$ from the velocity evolution of \ion{Si}{2}.
  ...
  respectively. \textit{Right panel:} Observed \ion{Si}{2}\,$\lambda$6355
  ...
  \ion{C}{2}\,$\lambda\lambda$6580, 7234 are also shown. Typical uncertainties
  are smaller than the size of the points. \textit{Right inset}: Evolution of
  the pseudo-equivalent width of \ion{Si}{2}\,$\lambda$6355, and
  \ion{C}{2}\,$\lambda\lambda$6580, 7234 in the $\sim$7\,d following 
  explosion.}
...
The early spectra of \abc\ exhibit unusually strong \ion{C}{2} $\lambda\lambda$6580, 7234 absorption. The evolution of these
...
velocity evolution of \ion{C}{2} to \ion{Si}{2} in the right panel of Figure
...
namely, the \textbf{strength} of \ion{C}{2}\,$\lambda$6580 is \textbf{similar
to} \ion{Si}{2}\,$\lambda$6355 at $t \approx -16 \, \mathrm{d}$ before
decreasing and eventually disappearing around $t = -10$ d.

The detection of \ion{C}{2} in SN Ia spectra is relatively rare as it requires
...
or after $T_{B,_\mathrm{max}}$ rarely show \ion{C}{2} as the photosphere has
receded from the outermost ejecta, while pre-max spectra show evidence for
weak \ion{C}{2} absorption in $\sim$1/4 of all normal SNe Ia (e.g.,
...
\ion{C}{2} features like \abc\
\citep{2013ApJ...778L..15Z,2017ApJ...845L..11H}. As a counterexample,
SN\,2011fe only exhibited weak \ion{C}{2} features in its first spectra
