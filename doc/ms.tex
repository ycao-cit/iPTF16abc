...
best-fit model we obtain $\alpha=0.98 \pm ^{0.06}_{0.10}$ and $t_0=-17.94 \pm ^{0.05}_{0.06}$ d, where the uncertainties represent the marginalized 95\% confidence intervals. Our first
...
\begin{figure*}[!thb]
  ...
  \caption{Constraints on $t_{exp}$ from fitting the velocity
    ...
    99.7\% confidence interval from Section
